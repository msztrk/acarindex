...
const footerLinkClass =
  'type-footer-link inline-flex min-h-6 items-center rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 no-underline'
      ...
      <div className="content-width py-4 md:py-8">
        <div className="grid grid-cols-2 gap-x-5 gap-y-3 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          <div className="col-span-2 sm:col-span-2 lg:col-span-1">
            ...
            <p className="type-footer-caption mt-1.5 max-w-sm leading-snug md:mt-3 md:leading-relaxed">
              {m.footer.tagline}
            </p>
          </div>

          <div>
            <h3 className="type-footer-heading mb-1 md:mb-2">
              {m.footer.explore}
            </h3>
        ...
        <div className="type-footer-caption mt-3 flex flex-col items-center justify-between gap-1 border-t border-border/70 pt-2.5 sm:flex-row md:mt-6 md:gap-2 md:pt-4">
